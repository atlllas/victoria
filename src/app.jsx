...
function HexagramDetails({ details, pointerEvents, setPointerEvents, activeInput, setActiveInput, setShowDiv }) {
    ...
    useEffect(() => {
        // Reset state to default values when component mounts
        setOverlayOpacity(1);
        setDetailsOpacity(1);
        setShowText(false);
    ...
    const handleCastAnotherClick = (event) => {
        ...
        setShowStarButton(false);
        setActiveInput(true);
        setPointerEvents("auto");  // Set to auto
        setShowDiv(false); // Ensure this is set to false here
    };
    ...
    const handleDivClick = () => {
        ...
        setTimeout(() => {
            ...
            setOverlayOpacity(1); // Fade in the new line
        }, 1200); // This should match the transition duration
    };
...
export function App() {
    ...
    const [detailsOpacity, setDetailsOpacity] = useState(1);  // Set default value to 1
    ...
    return (
            <div>
                ...
                {showDiv && hexagramDetails && 
                    ...
                    setShowDiv={setShowDiv} // Pass it down here
                    />
                    </div>
                }
            </div>
